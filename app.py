                ...
                try:
                    ...
                    if messaging_event.get("postback"):
                        if messaging_event['postback']['payload'] == "add_tea":
                            ...
                            if basket_process.check_file(sender_id, "demli_cay", 1):
                            ...
                            if basket_process.check_file(sender_id, "soguk_su", 1):
